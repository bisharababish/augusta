...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Augusta Victoria Hospital — Cancer Care" },
      { name: "description", content: "Augusta Victoria Hospital (المطلع) — chemotherapy, radiation, physiotherapy and patient support portal." },
    ],
    links: [
